                ...
                <div class="buttons" style="padding-left:10px;padding-top:10px;">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">                     
                        ...
                        <li>  <a href="#myAlert7" data-toggle="modal" ><i class="icon-retweet"></i> Change Water Meter</a></li>
                        <?php
                        foreach ($consumer_details as $row){
                          echo "<li><a href='#delete_".$row['account_no']."' data-toggle='modal'><i class='icon-remove-circle'></i> Delete Ledger </a></li>";
                        }
                        ?>
                  </ul>
                  </div>
                     ...
                     ?>
                      ...
                      <?php
                        ...
                        echo "<div class='span4'>
                         ...
                         <div id='delete_".$row['account_no']."' class='modal hide'>
                           <form action='".base_url("index.php/main/deleteLedger/".$row['account_no'])."' method='post' class='form-horizontal'>
                              <div class='modal-header'>
                                <button data-dismiss='modal' class='close' type='button'>×</button>
                                <h3>Delete Ledger</h3>
                              </div>
                              <div class='modal-body'>
                                  ...
                                  <br>
                                  Deleting Consumer: <b>".substr($row['date_installed'],0,4).substr($row['date_installed'],4,4).str_pad($row['account_no'], 4, '0', STR_PAD_LEFT)."</b><br>
