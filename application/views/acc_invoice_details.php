...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#"><i class="icon-home"></i> Manage Billing</a><a href="<?php echo base_url('index.php/main/viewBilledConsumers');?>" title="Go to Manage Bills" class="tip-bottom">Manage Bills</a>
    <?php
